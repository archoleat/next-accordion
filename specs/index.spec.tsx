...
describe("AccordionItem", () => {
  ...
  spec("should disable text selection on the trigger when disableTriggerSelection is set", () => {
    render(
    ...
    expect(screen.getByText("Summary").closest("summary")?.style.userSelect).toBe("none");
  });
